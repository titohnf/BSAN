...
export const MOCK_PENGAJUAN: PengajuanPokja[] = [
  {
    ...
    members: [
      makeMember("Ketua Kelompok Kerja", "Dr. Rizal Aditya, M.Pd", "rizal.aditya@aceh.go.id", "Laki-Laki", "08111234567", "Dinas Pendidikan Prov. Aceh"),
      makeMember("Wakil Ketua Kelompok Kerja", "Sari Dewi, S.Pd", "sari.dewi@aceh.go.id", "Perempuan", "08122345678", "Dinas Pendidikan Prov. Aceh"),
  ...
  },
  {
    ...
    status: "menunggu-validasi",
    members: [
      makeMember("Ketua Kelompok Kerja", "Prof. Andi Kurniawan", "andi.kurniawan@sumut.go.id", "Laki-Laki", "08222345678", "Dinas Pendidikan Prov. Sumut"),
      makeMember("Wakil Ketua Kelompok Kerja", "Mardiana Lubis, M.Pd", "mardiana.lubis@sumut.go.id", "Perempuan", "08233456789", "Dinas Pendidikan Prov. Sumut"),
  ...
  },
  {
    ...
    status: "menunggu-validasi",
    members: [
      makeMember("Ketua Kelompok Kerja", "Prof. Asep Kurniawan", "asep.kurniawan@jabar.go.id", "Laki-Laki", "08411234567", "Dinas Pendidikan Prov. Jabar"),
      makeMember("Wakil Ketua Kelompok Kerja", "Neneng Susilawati, M.Pd", "neneng.susilawati@jabar.go.id", "Perempuan", "08422345678", "Dinas Pendidikan Prov. Jabar"),
  ...
  },
  {
    ...
    members: [
      makeMember("Ketua Kelompok Kerja", "Dr. Slamet Riyadi", "slamet.riyadi@jateng.go.id", "Laki-Laki", "08511234567", "Dinas Pendidikan Prov. Jateng"),
      makeMember("Wakil Ketua Kelompok Kerja", "Sumiati Rahayu, M.Pd", "sumiati.rahayu@jateng.go.id", "Perempuan", "08522345678", "Dinas Pendidikan Prov. Jateng"),
