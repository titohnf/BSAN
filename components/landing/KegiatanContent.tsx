...
export const MOCK_KEGIATAN: Kegiatan[] = [
  ...
  { no: 4, nama: "Webinar Nasional: Budaya Sekolah Aman", penyelenggara: "Kemendikdasmen", wilayah: "Online", tanggal: "2025-05-12", status: "Selesai", peserta: 500, deskripsi: "Webinar nasional yang membahas strategi implementasi budaya sekolah aman dan nyaman." },
  { no: 5, nama: "Bimtek Monitoring dan Evaluasi BSAN", penyelenggara: "Pusat Penguatan Karakter", wilayah: "Surabaya", tanggal: "2025-05-20", status: "Selesai", peserta: 60, deskripsi: "Bimbingan teknis untuk petugas yang menangani monitoring dan evaluasi program BSAN." },
  { no: 6, nama: "Forum Koordinasi Pokja BSAN Sumatera", penyelenggara: "Kemendikdasmen", wilayah: "Medan", tanggal: "2025-06-03", status: "Berlangsung", peserta: 90, deskripsi: "Forum koordinasi antar Kelompok Kerja BSAN di wilayah Sumatera." },
  { no: 7, nama: "Pelatihan Guru: Pencegahan Kekerasan di Sekolah", penyelenggara: "Dinas Pendidikan DKI Jakarta", wilayah: "Jakarta", tanggal: "2025-06-10", status: "Berlangsung", peserta: 200, deskripsi: "Pelatihan untuk guru-guru di DKI Jakarta tentang pencegahan dan penanganan kekerasan di lingkungan sekolah." },
  { no: 8, nama: "Rapat Koordinasi Pokja BSAN Nasional", penyelenggara: "Kemendikdasmen", wilayah: "Jakarta", tanggal: "2025-06-25", status: "Akan Datang", peserta: 150, deskripsi: "Rapat koordinasi seluruh Pokja BSAN tingkat nasional untuk evaluasi semester pertama." },
  { no: 9, nama: "Workshop BSAN untuk Kepala Sekolah", penyelenggara: "Dinas Pendidikan Jawa Tengah", wilayah: "Semarang", tanggal: "2025-07-08", status: "Akan Datang", peserta: 75, deskripsi: "Workshop khusus kepala sekolah tentang implementasi kebijakan BSAN di tingkat satuan pendidikan." },
